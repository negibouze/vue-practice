...
module.exports = (env) => {
    ...
    return {
        ...
        module: {
            rules: [
                { test: /\.vue$/, exclude: [/node_modules/, /__tests__/], loader: 'vue-loader', options: {} },
                { test: /\.js$/, exclude: [/node_modules/, /__tests__/], loader: 'babel-loader' },
                {
                    test: /\.tsx?$/,
                ...
                {
                    test: /\.(styl|stylus)$/, exclude: [/node_modules/, /__tests__/],
                    use: [
                        'vue-style-loader',
                        {
                            loader: 'css-loader',
